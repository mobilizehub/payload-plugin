...
- f219a4b: Add letter campaigns. A `letters` collection holds the campaign: who the letter is addressed to, the
...
- 75a5318: feat: per-record email idempotency keys, plus `replyTo`, `previewText` and unsubscribe fixes
